...
const Settings = lazy(() => import("@/pages/reports/SettingsNew"));
...
const GrossProfitReport = lazy(() => import("@/pages/GrossProfitReport"));
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/evotor/gross-profit" element={<GrossProfitReport />} />
      </Routes>
    </Suspense>
  );
}
