      ...
      <div className="relative p-3 flex-1 flex flex-col justify-between">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-1 min-w-0">
            <ShoppingCart className="w-4 h-4 opacity-80 shrink-0" />
        ...
        <div className="flex items-end justify-between gap-1.5">
          <div className="min-w-0 flex-1">
            <div className="text-xl font-bold tabular-nums truncate leading-tight">{formatRub(netRevenue)} ₽</div>
            <div className="text-xs opacity-90 mt-0.5 truncate space-y-0.5">
